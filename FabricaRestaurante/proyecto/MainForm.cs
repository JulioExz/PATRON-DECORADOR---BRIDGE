...
namespace FabricasRestaurantes
{
    public class MainForm : Form
    {
        ...
        private readonly double[] _costoBebida = { 30, 25, 20, 35, 40 };
        private readonly double[] _costoPostre = { 25, 30, 15, 28, 45 };
        ...
        private void MostrarPasoPostre()
        {
            ...
            btnConfirmar.Click += (s, e) =>
            {
                ...
                double total = _platilloActual.Costo + _costoBebida[_idx] + _costoPostre[_idx] + _costoExtra;
        ...
        private void MostrarMenu(int idx)
        {
            ...
            _lblBebida.Text = bebida.Servir() + $"  —  ${_costoBebida[idx]}";
            _lblPostre.Text = postre.Servir() + $"  —  ${_costoPostre[idx]}";
